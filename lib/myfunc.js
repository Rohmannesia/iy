...
// exports serialize
exports.serialize = (rohmanzx, msg) => {
...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === rohmanzx.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = rohmanzx.user.id.split(':')[0]+'@s.whatsapp.net'
}
